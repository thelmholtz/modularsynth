    ...
    play(){
        this.filter.frequency.linearRampToValueAtTime
            ( this.options.filter.cutoff
                + this.options.filter.envelope.amount * (MAX_FREQ - this.options.filter.cutoff)
            , this.audioInstance.currentTime
                + this.options.filter.envelope.attack
            )
        ...
        this.filter.frequency.linearRampToValueAtTime
            ...
            , this.audioInstance.currentTime
                + this.options.filter.envelope.decay
            )
    }
